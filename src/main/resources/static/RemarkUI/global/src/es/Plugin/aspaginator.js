        ...
        prev: {
          tpl() {
            return `<li class="${this
              .namespace}-prev page-item"><a class="page-link" v-on:click="pageSeach" aria-label="Prev"><span class="icon wb-chevron-left-mini"></span></a></li>`;
          }
        },
        next: {
          tpl() {
            return `<li class="${this
              .namespace}-next page-item"><a class="page-link" v-on:click="pageSeach" aria-label="Next"><span class="icon wb-chevron-right-mini"></span></a></li>`;
          }
        },
        lists: {
          tpl() {
            ...
            for (let k = 1; k < remainder; k++) {
              lists += `<li class="${this
                ...
                remainder +
                k}"><a class="page-link" v-on:click="pageSeach">${this
                .currentPage -
                remainder +
                k}</a></li>`;
            }
            lists += `<li class="${this.namespace}-items page-item ${this
              ...
              .currentPage}"><a class="page-link" v-on:click="pageSeach">${this
              .currentPage}</a></li>`;
            for (
              ...
              lists += `<li class="${this
                .namespace}-items page-item" data-value="${i}"><a class="page-link" v-on:click="pageSeach">${i}</a></li>`;
            }
